...
* **多提供商接入**：支持 **Google Gemini / ChatGPT（OpenAI）/ Claude（Anthropic）/ Grok（xAI）**，可按需配置对应 API Key 并切换模型。
...
2. 点击左下角 ⚙️ **偏好设置** -> **系统**，填入你要使用的模型对应的 **API Key**（支持 Gemini / OpenAI / Anthropic / xAI）。
3. 开始沉浸式对话。
<br />
